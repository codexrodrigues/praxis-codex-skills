# Revisar skill praxis: praxis-stepper-wizard-runtime

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-stepper-wizard-runtime para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
