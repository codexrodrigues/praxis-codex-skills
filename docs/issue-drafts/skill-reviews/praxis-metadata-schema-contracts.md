# Revisar skill praxis: praxis-metadata-schema-contracts

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-metadata-schema-contracts para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
