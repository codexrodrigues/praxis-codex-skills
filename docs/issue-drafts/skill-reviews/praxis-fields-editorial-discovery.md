# Revisar skill praxis: praxis-fields-editorial-discovery

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-fields-editorial-discovery para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-fields-editorial-discovery/
- Descricao atual: Use when changing @praxisui/dynamic-fields or praxis-dynamic-fields package editorial descriptors, ComponentMetadataRegistry entries, component doc metadata, field catalogs, inventory, metadata-editor/dynamic-form discovery, i18n copy, control friendly names/icons/tags, or any case where a field renders at runtime but must also be discoverable by authoring tools.
