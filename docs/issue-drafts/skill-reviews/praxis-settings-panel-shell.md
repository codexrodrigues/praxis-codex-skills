# Revisar skill praxis: praxis-settings-panel-shell

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-settings-panel-shell para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-settings-panel-shell/
