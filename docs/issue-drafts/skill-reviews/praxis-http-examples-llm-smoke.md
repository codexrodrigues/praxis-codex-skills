# Revisar skill praxis: praxis-http-examples-llm-smoke

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-http-examples-llm-smoke para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
