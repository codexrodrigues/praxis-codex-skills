# Revisar skill praxis: praxis-table-authoring-settings

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-table-authoring-settings para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-table-authoring-settings/
- Descricao atual: Use when Codex must work on @praxisui/table authoring, Settings Panel integration, config editors, columns editor, behavior editor, filter settings editor, toolbar actions editor, rules editor, CRUD integration editor, value mapping, visual formula builder, JSON config editor, apply/save/reset, or runtime/editor round-trip.
