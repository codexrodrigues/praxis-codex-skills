# Revisar skill praxis: praxis-rules-engine-runtime

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-rules-engine-runtime para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-rules-engine-runtime/
- Descricao atual: Implement, review, debug, or extend the deterministic Praxis rules engine, including JSON Logic parity, RuleSet contracts, composition slots, planner DAGs, versioned Java executors, five-state decisions, limits, packaging, and neutral host consumption.
