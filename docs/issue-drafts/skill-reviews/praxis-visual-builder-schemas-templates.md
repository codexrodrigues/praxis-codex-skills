# Revisar skill praxis: praxis-visual-builder-schemas-templates

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-visual-builder-schemas-templates para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-visual-builder-schemas-templates/
