# Revisar skill praxis: praxis-java-contract-conformance

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-java-contract-conformance para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
