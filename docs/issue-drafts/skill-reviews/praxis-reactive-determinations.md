# Revisar skill praxis: praxis-reactive-determinations

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-reactive-determinations para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-reactive-determinations/
- Descricao atual: Use when implementing, auditing, or proving Praxis Reactive Determinations across metadata, governed rule snapshots, Java hosts, Angular Dynamic Form/CRUD/Stepper, diagnostics, and HTTP corpus: definition registries, trigger/form modes, input/output bindings, provenance, execution ordering, stale/cancel handling, last-known-good snapshot consumption, or migration away from legacy Form Effects.
