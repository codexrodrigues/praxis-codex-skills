# Revisar skill praxis: praxis-form-actions-hooks-runtime

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-form-actions-hooks-runtime para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-form-actions-hooks-runtime/
- Descricao atual: Use when Codex must work on @praxisui/dynamic-form or praxis-dynamic-form package actions, hooks, PraxisFormActionsComponent, action authoring, global action refs, surface open payloads, action visibility/shortcuts, submit/cancel/reset/custom action behavior, hook registries, or action editor round-trip.
