# Revisar skill praxis: praxis-ai-assistant-runtime

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-ai-assistant-runtime para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-ai-assistant-runtime/
- Descricao atual: Use when changing or reviewing `@praxisui/ai` assistant runtime, AI backend client, assistant shell/dock/session host, turn streaming, quick replies, clarifications, diagnostics, previews, apply payloads, history, runtime observations, `/api/praxis/config/ai/**` integration, or AI UX state materialization.
