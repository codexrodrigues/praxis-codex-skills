# Revisar skill praxis: praxis-ai-composer-attachments-quick-replies

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-ai-composer-attachments-quick-replies para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Descricao atual: Use when implementing, auditing, or consuming `@praxisui/ai` composer submission, quick replies, recommended intents, clarification continuation, pasted/selected attachments, safe attachment forwarding, edit/resend/feedback actions, governed provider-backed audio transcription, MediaRecorder capture, or optional browser speech compatibility.
