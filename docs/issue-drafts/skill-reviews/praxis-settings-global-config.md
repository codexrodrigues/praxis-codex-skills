# Revisar skill praxis: praxis-settings-global-config

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-settings-global-config para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
