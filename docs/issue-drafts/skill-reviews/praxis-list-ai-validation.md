# Revisar skill praxis: praxis-list-ai-validation

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-list-ai-validation para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-list-ai-validation/
- Descricao atual: Use when changing or validating `@praxisui/list` AI authoring: `PRAXIS_LIST_AUTHORING_MANIFEST`, list AI capabilities, context packs, AI adapter, agentic turn flow, component edit plans, declared-only warnings, registry ingestion, backend grounding, and assistant validation for list/card/tile configs.
