# Revisar skill praxis: praxis-core-domain-governance-runtime

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-core-domain-governance-runtime para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-core-domain-governance-runtime/
- Descricao atual: Use when Codex must implement, audit, or consume @praxisui/core domain governance runtime services: DomainCatalogService, DomainKnowledgeService, DomainRuleService, domain catalog context packs, domain 360 discovery, governed rule intake/simulation/publication/materialization, config-starter headers, or Angular projections of AI-authored semantic decisions.
