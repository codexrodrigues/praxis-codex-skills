# Revisar skill praxis: praxis-landing-dynamic-page-studio

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-landing-dynamic-page-studio para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
