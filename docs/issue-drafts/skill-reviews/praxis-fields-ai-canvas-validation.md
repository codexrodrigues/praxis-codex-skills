# Revisar skill praxis: praxis-fields-ai-canvas-validation

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-fields-ai-canvas-validation para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-fields-ai-canvas-validation/
- Descricao atual: Use when changing or auditing @praxisui/dynamic-fields or praxis-dynamic-fields package AI authoring manifest, control-type AI catalog, authoring profiles, AI registry ingestion, canvas integration tokens, playground recipes, generated component docs, or validation that dynamic field runtime/editorial/canvas coverage is actually available to AI-assisted authoring.
