# Revisar skill praxis: praxis-list-authoring-settings

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-list-authoring-settings para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-list-authoring-settings/
- Descricao atual: Use when creating, changing, or auditing `@praxisui/list` authoring surfaces: list config editor, widget config editor, JSON config editor, Settings Panel integration, `ListAuthoringDocument`, `SettingsValueProvider`, apply/save/reset/reopen, template/action/selection/skin editors, i18n chrome, and runtime/editor parity.
