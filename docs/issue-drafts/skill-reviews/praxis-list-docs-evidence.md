# Revisar skill praxis: praxis-list-docs-evidence

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-list-docs-evidence para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-list-docs-evidence/
- Descricao atual: Use when updating or auditing `@praxisui/list` README, json-api docs, docs manifest, living examples, executive reference evidence, docs shell publication, landing/playground synchronization, declared-only status tables, screenshots, or example/E2E evidence for list/card/tile behavior.
