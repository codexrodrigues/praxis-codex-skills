# Revisar skill praxis: praxis-config-ai-registry-manifests

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-config-ai-registry-manifests para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
