# Revisar skill praxis: praxis-settings-ai-i18n-validation

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-settings-ai-i18n-validation para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
