# Revisar skill praxis: praxis-java-http-corpus-publication

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-java-http-corpus-publication para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
