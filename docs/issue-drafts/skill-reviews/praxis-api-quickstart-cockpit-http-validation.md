# Revisar skill praxis: praxis-api-quickstart-cockpit-http-validation

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-api-quickstart-cockpit-http-validation para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Projeto canonico: praxis-api-quickstart
- Area: api-quickstart
- Risco: medio
- Estado: backlog
