# Revisar skill praxis: praxis-core-providers-bootstrap

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-core-providers-bootstrap para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-core-providers-bootstrap/
- Descricao atual: Use when Codex must implement, audit, document, or consume shared `@praxisui/core` providers, tokens, bootstrap utilities, global config, API URL, fetch headers, loading providers, icon providers, field selector registry providers, collection export providers, enterprise runtime context, public API exports, or cross-lib provider wiring for Praxis Angular packages and hosts.
