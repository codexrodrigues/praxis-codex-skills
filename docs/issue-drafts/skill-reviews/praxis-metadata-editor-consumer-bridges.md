# Revisar skill praxis: praxis-metadata-editor-consumer-bridges

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-metadata-editor-consumer-bridges para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-metadata-editor-consumer-bridges/
- Descricao atual: Use when integrating or reviewing consumers of `@praxisui/metadata-editor`, including dynamic-form canvas/layout editor, table filter settings, manual-form metadata bridge, Page Builder hosted editors, Settings Panel open/apply/save flows, lazy imports of `FieldMetadataEditorComponent`, cascade tab hosting, JSON Merge Patch application, and avoiding duplicate metadata semantics in consumers.
