# Revisar skill praxis: praxis-component-minimums

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-component-minimums para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-component-minimums/
- Descricao atual: Use when Codex needs to explain or implement the minimum viable setup for Praxis UI components, especially questions like what is the smallest config needed to render a dynamic form or table, where metadata comes from, whether resourcePath alone is enough, or what host services are required for schema-driven runtime bootstrap.
