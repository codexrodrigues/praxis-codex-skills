# Revisar skill praxis: praxis-table-runtime-data

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-table-runtime-data para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-table-runtime-data/
- Descricao atual: Use when Codex must inspect, change, or scaffold @praxisui/table runtime behavior: remote versus local data mode, TableConfig, columns, pagination, sorting, expansion, renderers, selection, CRUD resourcePath, GenericCrudService integration, export, analytics projections, or runtime observations.
