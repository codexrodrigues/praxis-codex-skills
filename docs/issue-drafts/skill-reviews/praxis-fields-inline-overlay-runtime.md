# Revisar skill praxis: praxis-fields-inline-overlay-runtime

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-fields-inline-overlay-runtime para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-fields-inline-overlay-runtime/
- Descricao atual: Use when Codex must implement, audit, or consume @praxisui/dynamic-fields or praxis-dynamic-fields package inline filter controls and overlays: inline* controlTypes, praxis-filter promotion, inlineOverlay.applyMode auto/explicit, apply/cancel/clear actions, draft versus committed value, overlay/panel tokens, CDK layer issues, clearButton, inlineAutoSize, inline context tooltips, compact toolbar value shapes, and inline filter docs/catalogs.
