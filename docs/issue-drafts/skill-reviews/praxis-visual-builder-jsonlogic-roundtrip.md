# Revisar skill praxis: praxis-visual-builder-jsonlogic-roundtrip

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-visual-builder-jsonlogic-roundtrip para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
