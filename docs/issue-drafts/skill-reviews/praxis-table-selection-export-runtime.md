# Revisar skill praxis: praxis-table-selection-export-runtime

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-table-selection-export-runtime para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-table-selection-export-runtime/
- Descricao atual: Use when Codex must implement, audit, or debug @praxisui/table selection and export operations: rowClick, selectionChange, selected rows/ids context, bulk actions, export formats/scopes, PraxisCollectionExportService, filtered/currentPage/selected/all scopes, collection capabilities, toolbar export UI, or AI selected-record context.
