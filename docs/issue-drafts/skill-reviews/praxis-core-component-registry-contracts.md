# Revisar skill praxis: praxis-core-component-registry-contracts

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-core-component-registry-contracts para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-core-component-registry-contracts/
- Descricao atual: Use when Codex must implement, audit, or consume @praxisui/core ComponentMetadataRegistry contracts: component docs metadata, editorial descriptors, component type aliases, input/output defaults, ports, insertion presets, i18n resolution, widget catalog discovery, Page Builder/Visual Builder registry projection, or AI component context grounding.
