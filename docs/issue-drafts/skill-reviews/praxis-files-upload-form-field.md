# Revisar skill praxis: praxis-files-upload-form-field

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-files-upload-form-field para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
