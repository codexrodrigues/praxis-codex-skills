# Revisar skill praxis: praxis-editorial-forms-data-collection-adapters

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-editorial-forms-data-collection-adapters para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-editorial-forms-data-collection-adapters/
- Descricao atual: Use when implementing or auditing `@praxisui/editorial-forms` `dataCollection` blocks, `EditorialDataBlockAdapter`, `EDITORIAL_DATA_BLOCK_ADAPTER`, `EditorialDataBlockAdapterRegistry`, adapter resolution statuses, `EditorialDataCollectionBlockOutletComponent`, `provideEditorialDynamicFormAdapter()`, runtime form config lookup, adapter diagnostics, and dynamic-form delegation.

## Classificacao inicial

- Projeto canonico: praxis-ui-angular
- Area: editorial-forms
- Risco: medio
- Estado: backlog
