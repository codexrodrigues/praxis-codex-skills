# Revisar skill praxis: praxis-angular-docs-playgrounds

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-angular-docs-playgrounds para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
