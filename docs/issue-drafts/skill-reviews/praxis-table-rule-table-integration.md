# Revisar skill praxis: praxis-table-rule-table-integration

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-table-rule-table-integration para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
