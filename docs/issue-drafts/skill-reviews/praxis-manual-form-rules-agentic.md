# Revisar skill praxis: praxis-manual-form-rules-agentic

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-manual-form-rules-agentic para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-manual-form-rules-agentic/
- Descricao atual: Use when implementing or auditing `@praxisui/manual-form` AI authoring, `PRAXIS_MANUAL_FORM_AUTHORING_MANIFEST`, `MANUAL_FORM_AI_CAPABILITIES`, component edit plans, `ManualFormConfigEditorComponent`, Settings Panel round-trip, `formRules`, `formRulesState`, JSON Logic alignment, agentic turn flow, context packs, registry ingestion, or governed rule handoff.
