# Revisar skill praxis: praxis-config-agentic-authoring-streaming

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-config-agentic-authoring-streaming para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Projeto canonico: praxis-config-starter
- Area: config
- Risco: alto
- Estado: backlog
