# Revisar skill praxis: praxis-table-ai-validation

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-table-ai-validation para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-table-ai-validation/
- Descricao atual: Use when Codex must inspect, change, or validate @praxisui/table AI authoring: AI manifests, component edit plans, table AI capabilities, runtime operations, filter/action intent grounding, context packs, selected-record context, registry ingestion, AI recipes, or table assistant Playwright flows.
