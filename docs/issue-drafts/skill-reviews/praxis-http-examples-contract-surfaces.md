# Revisar skill praxis: praxis-http-examples-contract-surfaces

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-http-examples-contract-surfaces para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-http-examples-contract-surfaces/
- Descricao atual: Use when Codex must work on praxisui-http-examples contract request surfaces: metadata examples for /schemas/filtered, /schemas/catalog, /schemas/surfaces, /schemas/actions, /capabilities, _links, ETag and schema headers; config examples for /api/praxis/config/**, ui config, AI context, AI registry, domain rules, domain knowledge, authoring/patch/SSE, Origin and tenant headers.

## Classificacao inicial

- Projeto canonico: praxisui-http-examples
- Area: http-examples
- Risco: medio
- Estado: backlog
