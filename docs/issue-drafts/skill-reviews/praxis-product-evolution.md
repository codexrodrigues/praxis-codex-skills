# Revisar skill praxis: praxis-product-evolution

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-product-evolution para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-product-evolution/
- Descricao atual: Use when a real enterprise screen, workflow, workaround, or repeated customization may reveal a reusable Praxis platform capability: inventory native support, identify the canonical owner, distinguish application need from platform gap, compare abstraction options, and produce an evidence-backed platform RFC or owner follow-up.
