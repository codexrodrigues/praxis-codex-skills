# Revisar skill praxis: praxis-java-domain-governance-field-access

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-java-domain-governance-field-access para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-java-domain-governance-field-access/
- Descricao atual: Use when implementing, auditing, or migrating Praxis Java domain governance and field access: @DomainGovernance, AiUsagePolicy, x-ui.fieldAccess, personal/sensitive/financial/security data, masking, export and analytics eligibility, filters and option sources, audit/provenance fields, semantic domain catalog, and backend enforcement with Angular materialization.
