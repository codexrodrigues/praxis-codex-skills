# Revisar skill praxis: praxis-form-submit-payload-pipeline

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-form-submit-payload-pipeline para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-form-submit-payload-pipeline/
