# Revisar skill praxis: praxis-metadata-domain-option-sources

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-metadata-domain-option-sources para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-metadata-domain-option-sources/
- Descricao atual: Use when Codex must work on praxis-metadata-starter semantic domain and option-source contracts: @DomainGovernance, /schemas/domain, semantic metadata reviewer, @UISchema presets, fieldAccess, OptionSourceDescriptor, RESOURCE_ENTITY, filter/by-ids endpoints, selectedReloadPolicy, invalidSortPolicy, entity lookup metadata, or x-ui optionSource publication.

## Classificacao inicial

- Projeto canonico: praxis-metadata-starter
- Area: metadata
- Risco: alto
- Estado: backlog
