# Revisar skill praxis: praxis-editorial-forms-agentic-authoring

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-editorial-forms-agentic-authoring para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-editorial-forms-agentic-authoring/
- Descricao atual: Use when implementing or auditing `@praxisui/editorial-forms` AI authoring, `PRAXIS_EDITORIAL_FORMS_AUTHORING_MANIFEST`, component edit plans, snapshot/fallback/presentation operations, adapter binding, data block add/remove, field binding, registry ingestion, component metadata, docs, labs, and governed handoff to dynamic-form, metadata-editor, rich-content, or page-builder.
