# Revisar skill praxis: praxis-editorial-forms-presentation-diagnostics

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-editorial-forms-presentation-diagnostics para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-editorial-forms-presentation-diagnostics/
- Descricao atual: Use when implementing or auditing `@praxisui/editorial-forms` fallback states, diagnostics, operational events, `solution.presentation`, layout/theme/stepper helpers, unsupported presentation keys, runtime CSS variables, stepper behavior, i18n, and visual/runtime health reporting.
