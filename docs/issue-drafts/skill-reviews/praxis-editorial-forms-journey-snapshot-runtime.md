# Revisar skill praxis: praxis-editorial-forms-journey-snapshot-runtime

## Objetivo

Solicitar a um especialista em plataforma Praxis uma revisao criteriosa da skill praxis-editorial-forms-journey-snapshot-runtime para garantir que ela esteja 100% em conformidade com os recursos disponiveis do Praxis e com as melhores praticas de uso desses recursos.
...
- Familia: praxis
- Caminho: codex-skills/praxis-editorial-forms-journey-snapshot-runtime/
- Descricao atual: Use when implementing or auditing `@praxisui/editorial-forms` journey resolution, `EditorialRuntimeInput`, `EditorialSolutionDefinition`, `EditorialTemplateInstance`, `EditorialRuntimeState`, `resolveEditorialRuntimeSnapshot()`, context merge, presets, block provenance, overrides, runtime snapshots, and `snapshotChange`.
