...
5. Pass dashboard filters through `[queryContext]`; do not manually concatenate `statsPath` or duplicate stats request construction in Angular when `x-ui.chart` can derive it.
